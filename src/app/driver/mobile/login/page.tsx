...
export default function DriverLoginPage() {
  ...
  return (
    // FIX BOTTOM NAV BOCOR: Gunakan fixed, inset-0, dan z-[999] agar layar login ini
    // menutupi komponen layout apapun (termasuk bottom nav) di belakangnya.
    <main className="fixed inset-0 z-[999] bg-[#F8F9FA] flex flex-col items-center justify-center p-6 overflow-y-auto font-sans w-full">
      ...
      {/* Container Relative untuk Background Glow */}
      <div className="relative w-full max-w-sm flex flex-col items-center justify-center py-10 min-h-full">
        ...
        <div className="fixed top-[-10%] right-[-10%] w-[60%] h-[40%] bg-[#7A171D] rounded-full blur-[120px] opacity-15 pointer-events-none" />
