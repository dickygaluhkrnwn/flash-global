  ...
  (
    {
      ...
      accountName = "PT FLASH GLOBALS LOGISTIK",
    },
    ref
  ) => {
      ...
      >
        ...
        <div className="absolute top-[150mm] left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.03] pointer-events-none grayscale print:fixed print:top-1/2">
           <img 
             ...
             className="w-[150mm] object-contain" 
           />
        </div>
        ...
        <div className="flex justify-between items-start border-b-2 border-slate-900 pb-6 mb-8 relative z-10">
          ...
          <div className="text-right text-xs text-slate-600">
            <p className="font-bold text-slate-900 mb-1">PT. FLASH GLOBALS LOGISTIK</p>
            <p>Gedung Logistik Center Lt. 3</p>
            <p>Jl. Jend. Sudirman Kav. 21, Jakarta Selatan 12920</p>
            <p>NPWP: 02.123.456.7-890.000</p>
            <p className="mt-1">Email: finance@flashglobalslogistik.com | Telp: +62 21 555 1234</p>
          </div>
        </div>
